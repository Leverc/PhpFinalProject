    ...
    foreach($result as $row) {
        echo '<section class="updateSection">
              <form class="updateForm" action="editEntry.php" method="post">
                    <p><input name="fname" type="text" placeholder="' . $row['fname'] . '" required/></p>
                    <p><input name="lname" type="text" placeholder="' . $row['lname'] . '" /></p>
                    <p><input name="email" type="text" placeholder="' . $row['email'] . '" required /></p>
                    <p><input name="telNumber" type="text" placeholder="' . $row['telNumber'] . '" required /></p>
